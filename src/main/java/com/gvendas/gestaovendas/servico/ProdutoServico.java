...
public class ProdutoServico {
    ...
    public  Produto atualizar(Long codigoCategoria, Long codigoProduto, Produto produto) {
        Produto produtoSalvar = validarProdutoExite(codigoProduto, codigoCategoria);
        validarCategoriaDoProdutoExiste(codigoCategoria);
        validarProdutoDuplicado(produto);
    ...
    public void deletar(Long codigoCategoria, Long codigoProduto) {
        Produto produto = validarProdutoExite(codigoProduto, codigoCategoria);
    ...
    protected Produto validarProdutoExite(Long codigoProduto) {
    ...
    private Produto validarProdutoExite(Long codigoProduto, Long codigoCategoria) {
